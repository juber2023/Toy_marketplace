        ...
        <div className=" mx-auto flex items-center justify-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              <Link to="#" className="flex items-center bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg">
              ...
              <Link to="#" className="flex items-center bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg">
